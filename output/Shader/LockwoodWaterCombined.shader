	...
	SubShader {
		...
		Pass {
			...
			Program "vp" {
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "FOG_LINEAR" "VERTEX_COLOUR" }
					"!!GLES
					#version 100
					...
					void main ()
					{
					  ...
					  xlv_TEXCOORD0 = tmpvar_3;
					  xlv_TEXCOORD1 = ((worldSpaceVertex_2.xzxz + (_Time.xxxx * _BumpDirection)) * _BumpTiling);
					  xlv_TEXCOORD2 = ((tmpvar_6.z * unity_FogParams.z) + unity_FogParams.w);
					  xlv_COLOR0 = tmpvar_4;
					}
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "FOG_EXP" "VERTEX_COLOUR" }
					"!!GLES
					#version 100
					...
					void main ()
					{
					  ...
					  xlv_TEXCOORD0 = tmpvar_3;
					  xlv_TEXCOORD1 = ((worldSpaceVertex_2.xzxz + (_Time.xxxx * _BumpDirection)) * _BumpTiling);
					  xlv_TEXCOORD2 = exp2(-((unity_FogParams.y * tmpvar_6.z)));
					  xlv_COLOR0 = tmpvar_4;
					}
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "FOG_EXP2" "VERTEX_COLOUR" }
					"!!GLES
					#version 100
